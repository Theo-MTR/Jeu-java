...
public class Collision {
            ...
            public void handle(long l) {
                for (Shape s : Var.obstacles) {
                    if (Var.personnage.intersects(s.getBoundsInParent())) {
                        ...
                        else if (s instanceof Scie) actionPiege((Scie)  s);
                    }
                }
            }
        };
    ...
    private void actionPiege(Scie s) {
        System.out.println(s.getCenterX() + s.getRadius());
        System.out.println(Var.personnage.getX() + Var.personnage.getWidth());
        if (Var.toucheQ) {
            ...
            System.out.println(s.getCenterX() + s.getRadius() + " ok");
            System.out.println(Var.personnage.getX() + Var.personnage.getWidth());
